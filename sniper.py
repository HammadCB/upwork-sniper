...
# --- 🎯 EXPANDED FILTERS ---
KEYWORDS = [
    'python', 'scraping', 'selenium', 'automation', 'bot', 'script', 'extraction',
    'browser', 'crawler', 'playwright', 'requests', 'api', 'data mining',
    'machine learning', 'ai', 'face recognition', 'neural network', 'odoo'
]
